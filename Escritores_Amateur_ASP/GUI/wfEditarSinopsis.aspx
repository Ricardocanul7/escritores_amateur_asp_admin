<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/mpAdmin.Master" AutoEventWireup="true" CodeBehind="wfEditarSinopsis.aspx.cs" Inherits="Escritores_Amateur_ASP.GUI.wfEditarSinopsis" %>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <!--Contenido-->
                    <div class="form-group">
                        <asp:Label ID="lblNombre" runat="server" Text="Contenido:"></asp:Label>
                        <asp:TextBox ID="txtNombre" class="form-control" textMode="MultiLine" runat="server"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
