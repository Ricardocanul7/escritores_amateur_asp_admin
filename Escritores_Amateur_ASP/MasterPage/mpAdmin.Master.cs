...
namespace Escritores_Amateur_ASP.MasterPage
{
    public partial class mpAdmin : System.Web.UI.MasterPage
    {
        ...
        protected void lbtnTablaCapitulo_Click(object sender, EventArgs e)
        {
            Response.Redirect("../GUI/wfTablaCapitulo.aspx");
        }

        protected void lbtnTablaPrologo_Click(object sender, EventArgs e)
        {
            Response.Redirect("../GUI/wfTablaPrologo.aspx");
        }

        protected void lbtnTablaRevisiones_Click(object sender, EventArgs e)
        {
